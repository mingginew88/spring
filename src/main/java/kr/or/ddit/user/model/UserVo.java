...
public class UserVo implements HttpSessionBindingListener{
	...
	public void valueBound(HttpSessionBindingEvent event) {
		//seesion객체에서 session.setAttribute("userVo", userVo)가 호출 되었을떄
		logger.debug("httpSessionBinding valueBound : " + event.getName());
	}

	@Override
	public void valueUnbound(HttpSessionBindingEvent event) {
		//seesion객체에서 session.removeAttribute("userVo")가 호출 되었을떄
		logger.debug("httpSessionUnBinding valueBound : " + event.getName());
	}
